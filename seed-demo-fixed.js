...
// Resolve MongoDB URI (Atlas in prod, localhost in dev by default)
...
async function seedDemoData() {
  try {
    ...
    const existingBlogs = await Blog.find({ userId: demoUser._id });
    if (existingBlogs.length === 0) {
      ...
      const blogs = [
        {
          ...
          content: `<h2>Introduction</h2><p>Node.js has revolutionized server-side development by bringing JavaScript to the backend. In this post, we'll explore best practices for building scalable applications.</p><h2>Key Principles</h2><ul><li>Asynchronous programming patterns</li><li>Microservices architecture</li><li>Proper error handling</li><li>Database optimization</li></ul><h2>Performance Optimization</h2><p>Performance is crucial for scalable applications. Here are some strategies:</p><p>1. Use clustering to take advantage of multi-core systems</p><p>2. Implement caching strategies with Redis</p><p>3. Optimize database queries and use indexing</p><h2>Conclusion</h2><p>Building scalable Node.js applications requires careful planning and implementation of best practices. Start with a solid foundation and iterate as you grow.</p>`,
        ...
        },
        {
          ...
          content: `<h2>Evolution of Frontend</h2><p>Frontend development has come a long way from simple HTML and CSS. Today's frontend developers work with complex frameworks and tools.</p><h2>Emerging Trends</h2><ul><li>Component-based architecture</li><li>JAMstack approach</li><li>Progressive Web Apps</li><li>WebAssembly integration</li></ul><h2>Tools and Frameworks</h2><p>The modern frontend ecosystem includes powerful tools like React, Vue, Angular, and build tools like Vite and Webpack.</p><h2>What's Next?</h2><p>The future holds exciting possibilities with AI-assisted development, better performance optimization, and more intuitive developer experiences.</p>`,
      ...
      console.log('✅ Demo blog posts already exist');
    }
